...
class MyFirstModuleLogic(ScriptedLoadableModuleLogic):
  ...
  def placeSphere(self, markupsNode):
    import math
    p1 = [0.0, 0.0, 0.0]
    ...
    center = [(p2[0]+p1[0])/2, (p2[1]+p1[1])/2, (p2[2]+p1[2])/2]
    sphere.SetCenter(center)
    radius=math.sqrt((p2[0]-p1[0])**2+(p2[1]-p1[1])**2+(p2[2]-p1[2])**2)/2
